...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      ...
      className={cn(
        // раскладка
        "flex min-h-24 w-full px-3.5 py-2.5",
        // оформление
        "rounded-md border border-border bg-secondary text-base text-foreground outline-none transition-colors placeholder:text-muted-foreground",
        // состояния
