...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn("flex h-8 items-center gap-2.5 rounded-sm px-2.5", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
